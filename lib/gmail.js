...
export const PLATFORM_QUERIES = {
  zapier: 'from:contact@zapier.com subject:(task OR limit OR usage) newer_than:3y',
  make: 'from:(*@make.com OR *@integromat.com) subject:(operations OR credits OR limit) newer_than:3y',
  airtable: 'from:noreply@airtable.com subject:(automation OR usage) newer_than:3y',
  bubble: 'from:(*@bubble.io OR *@sendgrid.net) subject:(capacity OR usage OR workload) newer_than:3y',
}
