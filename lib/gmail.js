...
// Note: Gmail from: doesn't support wildcards, use domain matching
// Research: /research/03-email-domains-comprehensive.md
export const PLATFORM_QUERIES = {
  // Zapier: zapier.com (all subdomains), zapiermail.com (Email by Zapier action)
  // ESPs: hubspotemail.net, sendgrid.net, mailgun.org, sparkpostmail.com
  zapier: '(from:zapier.com OR from:zapiermail.com) newer_than:3y',

  // Make.com: make.com (with regional subdomains eu1, eu2, us1, us2), integromat.com (legacy), make.celonis.com (enterprise)
  make: '(from:make.com OR from:integromat.com OR from:make.celonis.com) newer_than:3y',

  // Airtable: airtable.com (system), airtableemail.com (automations)
  airtable: '(from:airtable.com OR from:airtableemail.com) newer_than:3y',

  // Bubble: bubble.io (system), bubbleapps.io (app emails), bubble.is (legacy)
  // Uses SendGrid for delivery
  bubble: '(from:bubble.io OR from:bubbleapps.io OR from:bubble.is) newer_than:3y',
}

// Combined query for all platforms
export const ALL_PLATFORMS_QUERY = `(${Object.values(PLATFORM_QUERIES).join(' OR ')}) newer_than:3y`
