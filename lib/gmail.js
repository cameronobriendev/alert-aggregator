...
export const PLATFORM_QUERIES = {
  zapier: 'from:zapier.com newer_than:3y',
  make: '(from:make.com OR from:integromat.com) newer_than:3y',
  airtable: 'from:airtable.com newer_than:3y',
  bubble: 'from:bubble.io newer_than:3y',
}
