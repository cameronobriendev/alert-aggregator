...
export function detectPlatform(email) {
  ...
  // FIRST: Exclude known non-platform senders that mention these platforms
  // Job boards, newsletters, monitoring tools - they talk ABOUT platforms, not FROM them
